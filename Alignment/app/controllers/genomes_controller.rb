class GenomesController < ApplicationController
  ...
  def create
    ...
    @genome.sequence = @genome.sequence.gsub(/\s+/, "")
  ...
  # Nahrani sekvence ze souboru
  def create_from_file
    Genome.create_from_file(params[:soubor])
  ...
  def update
    @genome = Genome.find(params[:id])
    params[:genome][:sequence] = params[:genome][:sequence].gsub(/\s+/, "")
